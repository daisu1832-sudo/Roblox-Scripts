...
start.Position=UDim2.fromOffset(18,65)
start.Size=UDim2.new(1,-36,0,58)
start.BackgroundColor3=OFF
...
stop.Position=UDim2.fromOffset(18,140)
stop.Size=UDim2.new(1,-36,0,58)
stop.BackgroundColor3=RED
stop.BorderSizePixel=0
stop.Text="ロケット終了"
stop.TextColor3=WHITE
stop.TextSize=18
stop.Font=Enum.Font.GothamBold
stop.AutoButtonColor=false
stop.Parent=page
local stc=Instance.new("UICorner")
stc.CornerRadius=UDim.new(0,14)
stc.Parent=stop
...
tab.MouseButton1Click:Connect(function() page.Visible=true end)

start.MouseButton1Click:Connect(function()
	if rocketRunning then return end
...
stop.MouseButton1Click:Connect(function()
	if not rocketRunning then return end
	if ENV.LEOPA_ROCKET_STOP then pcall(ENV.LEOPA_ROCKET_STOP) end
	ENV.LEOPA_ROCKET_STOP=nil
	rocketRunning=false
	start.Text="ロケット：オフ"
	start.BackgroundColor3=OFF
